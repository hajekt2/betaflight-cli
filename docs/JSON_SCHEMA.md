...
Parsed documents classify Betaflight import metadata and common CLI families such as `batch`, `defaults`, `save`, `board`, `beeper`, `beacon`, and `rxfail` separately from genuinely unknown syntax.
