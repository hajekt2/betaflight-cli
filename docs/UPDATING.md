...
The current generated registries are produced from official Betaflight `2026.6.1`.
Use a pinned upstream tag, not a moving branch, when updating checked-in generated files.

Example:

```sh
export BETAFLIGHT_VERSION=2026.6.1
...
- `make build-release` generated static binaries, `dist/SHA256SUMS`, and passed `verify-release-artifacts`.
