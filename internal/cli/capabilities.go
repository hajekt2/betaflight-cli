...
func coverageDomains(commandSet map[string]bool) []coverageDomain {
	domains := []coverageDomain{
		...
		implementedDomain("battery-failsafe", commandSet, []string{"betaflight-cli battery list", "betaflight-cli battery status", "betaflight-cli failsafe list", "betaflight-cli failsafe status"}, []string{"betaflight-cli battery set", "betaflight-cli battery set-config-json", "betaflight-cli battery set-voltage-meter", "betaflight-cli battery set-current-meter", "betaflight-cli failsafe set", "betaflight-cli failsafe set-arming-json", "betaflight-cli failsafe set-config-json", "betaflight-cli failsafe set-board-alignment"}, nil, []string{"battery", "battery_config", "failsafe", "arming_config", "failsafe_config", "change_plan", "board_alignment", "voltage_meter_config", "current_meter_config"}, "Battery and failsafe settings plus arming/failsafe status are covered; battery config, voltage/current meter calibration, arming config, failsafe config, and board alignment have confirmed typed MSP writes."),
