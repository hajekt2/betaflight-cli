...
func coverageDomains(commandSet map[string]bool) []coverageDomain {
	domains := []coverageDomain{
		...
		implementedDomain("live-monitoring", commandSet, []string{"betaflight-cli watch"}, nil, nil, []string{}, "Watch mode streams NDJSON runtime envelopes over one held connection at a bounded interval."),
...
func capabilityMetadataRegistry() map[string]capabilityMetadata {
	...
	registry := map[string]capabilityMetadata{
		...
		"betaflight-cli arming lock":                       {RequiresConnection: true, Operation: "write", Confirmation: "--yes", OutputRoot: "arming_lock", Tags: []string{"arming", "write"}},
		"betaflight-cli arming unlock":                     {RequiresConnection: true, Operation: "write", Confirmation: "--yes", OutputRoot: "arming_lock", Tags: []string{"arming", "write"}},
		...
		"betaflight-cli watch":                             {RequiresConnection: true, Operation: "read_only", Confirmation: "none", Input: "profile: telemetry, status, motors, or gps; flags --interval, --count, --duration emit NDJSON envelopes", Tags: []string{"watch", "streaming", "read"}},
		"betaflight-cli configuration reset":               {RequiresConnection: true, Operation: "dangerous", Confirmation: "--yes", OutputRoot: "change_plan", Tags: []string{"configuration", "dangerous", "reset"}},
		...
		"betaflight-cli blackbox analyze":                  {RequiresConnection: false, Operation: "offline", Confirmation: "none", OutputRoot: "analysis", Input: "Blackbox log file or stdin", Tags: []string{"blackbox", "offline", "analysis"}},
