...
var mspDecodeRegistry = map[uint16]mspPayloadDecoder{
	...
	msp.MSPCalculateSimplifiedPID:   decodeVia(commands.DecodeSimplifiedCalculatedPIDs),
	msp.MSPCalculateSimplifiedDterm: decodeVia(commands.DecodeSimplifiedFilterPayload),
	msp.MSPCalculateSimplifiedGyro:  decodeVia(commands.DecodeSimplifiedFilterPayload),
	msp.MSPValidateSimplifiedTuning: decodeVia(commands.DecodeSimplifiedTuningValidation),
